...
import { DeletePromoTileButton } from "@/components/delete-promo-tile-button";
              ...
              {slides.map((s) => (
                <tr key={s.id} className="hover:bg-neutral-50">
                  ...
                  <td className="px-4 py-2.5 text-right">
                    ...
                    <DeleteHeroSlideButton id={s.id} label={s.verseRefEn} />
                  </td>
                </tr>
              ))}
              {slides.length === 0 && (
              ...
              {tiles.map((t) => (
                <tr key={t.id} className="hover:bg-neutral-50">
                  ...
                  <td className="px-4 py-2.5 text-right">
                    ...
                    <DeletePromoTileButton id={t.id} label={t.labelEn} />
                  </td>
                </tr>
              ))}
              {tiles.length === 0 && (
